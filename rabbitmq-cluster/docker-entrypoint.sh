...
export K8S_SERVICE_NAME=${SERVICE_NAME}
export RABBITMQ_NODENAME=rabbit@${HOSTNAME}.${SERVICE_NAME}.${TENANT_ID}.svc.cluster.local
export K8S_HOSTNAME_SUFFIX=.${SERVICE_NAME}.${TENANT_ID}.svc.cluster.local
